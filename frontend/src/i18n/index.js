...
const resources = {
  en: {
    translation: {
      ...
      enterprise: {
        ...
        'step1_description': 'Enter your company details to get started',
        ...
        'description_placeholder': 'Brief description of your company...',
        'generate': 'Generate',
        'company_settings': 'Company Settings',
        'step2_description': 'Configure your company preferences',
        'address': 'Company Address',
        'timezone': 'Timezone',
        'currency': 'Currency',
        'language': 'Default Language',
        'review_and_submit': 'Review & Submit',
        'step3_description': 'Review your information before submitting',
        'company_summary': 'Company Summary',
        'not_provided': 'Not provided',
        'pricing_information': 'Pricing Information',
        'first_year_free': 'First year completely free',
        'base_pricing': 'Base pricing',
        'per_unit_per_month': 'per unit per month',
        'additional_compounds': 'Additional compounds',
        'volume_discounts_available': 'Volume discounts available (10-40% off)',
        ...
        'registration_successful': 'Company registered successfully!',
        ...
        'final_amount': 'Monthly Total',
        'first_year_free_active': 'First year free promotion active',
        'compounds': 'Compounds',
        'add_compound': 'Add Compound',
        'units': 'Units',
        'families': 'Families',
        'no_compounds': 'No compounds added yet',
        'add_first_compound': 'Add your first compound',
        'overview': 'Overview',
        'analytics': 'Analytics',
      ...
      'back_to_login': 'Back to Login',
        ...
        'advanced_analytics': 'Advanced Analytics',
        'need_help': 'Need Help Choosing?',
        'help_description': 'Our sales team is here to help you select the perfect plan',
        'contact_sales': 'Contact Sales',
        'schedule_demo': 'Schedule Demo',
        'fetch_error': 'Failed to load account options',
        'selection_success': 'Account type selected successfully!',
        'selection_error': 'Failed to select account type'
      },
      
      // Individual Compound System
      individual: {
        'compound_information': 'Compound Information',
        'step1_description': 'Enter your compound details to get started',
        'compound_name': 'Compound Name',
        'compound_name_placeholder': 'Enter compound name...',
        'address': 'Address',
        'address_placeholder': 'Enter compound address...',
        'total_units': 'Total Units',
        'max_units_note': 'Maximum 1,000 units for individual accounts',
        'compound_type': 'Compound Type',
        'residential': 'Residential',
        'commercial': 'Commercial',
        'mixed': 'Mixed Use',
        'description': 'Description',
        'description_placeholder': 'Brief description of your compound...',
        'pricing_preview': 'Pricing Preview',
        'monthly_cost': 'Monthly Cost',
        'annual_cost': 'Annual Cost',
        'trial_included': '1 month free trial included',
        'contact_preferences': 'Contact & Preferences',
        'step2_description': 'Set your contact information and preferences',
        ...
        'review_and_submit': 'Review & Submit',
        'step3_description': 'Review your compound details before creating',
        ...
        'feature_resident_management': 'Resident & Family Management',
        'feature_financial_tracking': 'Financial Tracking',
        'feature_maintenance_system': 'Maintenance System',
        'feature_communication_tools': 'Communication Tools',
        'feature_basic_reporting': 'Basic Reporting',
        'feature_mobile_access': 'Mobile Access',
        'feature_upgrade_option': 'Upgrade to Enterprise Anytime',
        'compound_info': 'Compound Info',
        'contact_settings': 'Contact & Settings',
        'review': 'Review',
        'previous': 'Previous',
        'next': 'Next',
        'create_compound': 'Create Compound',
        'registering': 'Creating...',
        'please_fill_required_fields': 'Please fill all required fields',
        'registration_successful': 'Compound created successfully!',
        'registration_failed': 'Failed to create compound. Please try again.'
      },
  ...
  ar: {
    translation: {
      ...
      // Enterprise System (Arabic)
      enterprise: {
        'dashboard': 'لوحة تحكم الشركات',
        'company_information': 'معلومات الشركة',
        'step1_description': 'أدخل تفاصيل شركتك للبدء',
        ...
        'description_placeholder': 'وصف مختصر عن شركتك...',
        'generate': 'إنتاج',
        'company_settings': 'إعدادات الشركة',
        'step2_description': 'تكوين تفضيلات شركتك',
        'address': 'عنوان الشركة',
        'timezone': 'المنطقة الزمنية',
        'currency': 'العملة',
        'language': 'اللغة الافتراضية',
        'review_and_submit': 'مراجعة وإرسال',
        'step3_description': 'راجع معلوماتك قبل الإرسال',
        'company_summary': 'ملخص الشركة',
        'not_provided': 'غير مقدم',
        'pricing_information': 'معلومات التسعير',
        'first_year_free': 'السنة الأولى مجانية تماماً',
        'base_pricing': 'التسعير الأساسي',
        'per_unit_per_month': 'لكل وحدة شهرياً',
        'additional_compounds': 'المجمعات الإضافية',
        'volume_discounts_available': 'خصومات الكمية متاحة (10-40% خصم)',
        ...
        'registration_successful': 'تم تسجيل الشركة بنجاح!',
        'registration_failed': 'فشل التسجيل. يرجى المحاولة مرة أخرى.',
        'dashboard_load_failed': 'فشل في تحميل بيانات لوحة التحكم',
        ...
        'final_amount': 'الإجمالي الشهري',
        'first_year_free_active': 'عرض السنة الأولى مجاناً نشط',
        'compounds': 'المجمعات',
        'add_compound': 'إضافة مجمع',
        'units': 'وحدات',
        'families': 'أسر',
        'no_compounds': 'لم تتم إضافة مجمعات بعد',
        'add_first_compound': 'أضف مجمعك الأول',
        'overview': 'نظرة عامة',
        'analytics': 'التحليلات',
  ...
  fr: {
    translation: {
      ...
      // Enterprise System (French)
      enterprise: {
        'dashboard': 'Tableau de Bord Entreprise',
        'company_information': 'Informations de l\'Entreprise',
        'step1_description': 'Entrez les détails de votre entreprise pour commencer',
        ...
        'description_placeholder': 'Brève description de votre entreprise...',
        'generate': 'Générer',
        'company_settings': 'Paramètres de l\'Entreprise',
        'step2_description': 'Configurez vos préférences d\'entreprise',
        'address': 'Adresse de l\'Entreprise',
        'timezone': 'Fuseau Horaire',
        'currency': 'Devise',
        'language': 'Langue par Défaut',
        'review_and_submit': 'Réviser et Soumettre',
        'step3_description': 'Révisez vos informations avant de soumettre',
        'company_summary': 'Résumé de l\'Entreprise',
        'not_provided': 'Non fourni',
        'pricing_information': 'Informations de Tarification',
        'first_year_free': 'Première année entièrement gratuite',
        'base_pricing': 'Tarification de base',
        'per_unit_per_month': 'par unité par mois',
        'additional_compounds': 'Complexes supplémentaires',
        'volume_discounts_available': 'Remises de volume disponibles (10-40% de réduction)',
        ...
        'registration_successful': 'Entreprise enregistrée avec succès!',
        'registration_failed': 'Échec de l\'enregistrement. Veuillez réessayer.',
        ...
        'pricing_summary': 'Résumé de la Tarification',
        'base_amount': 'Montant de Base',
        'additional_amount': 'Montant Supplémentaire',
        'volume_discount': 'Remise de Volume',
        'final_amount': 'Total Mensuel',
        'first_year_free_active': 'Promotion première année gratuite active',
        'compounds': 'Complexes',
        'add_compound': 'Ajouter un Complexe',
        'units': 'Unités',
        'families': 'Familles',
        'no_compounds': 'Aucun complexe ajouté encore',
        'add_first_compound': 'Ajoutez votre premier complexe',
        'overview': 'Aperçu',
        'analytics': 'Analyses',

...
const FAQS = [
  ...
  },
  {
    ...
    a: 'مجاني: حتى 30 ساكن (0 ج.م). أساسي: حتى 100 ساكن (1,200 ج.م/شهر). احترافي: غير محدود (2,200 ج.م/شهر) + مساعد AI. متقدم: غير محدود + كل الميزات (4,000 ج.م/شهر). شركات: ناشئة 5,500 | متوسطة 13,000 | كبرى 35,000 ج.م/شهر. خصم 17% للتجديد السنوي.',
  },
  {
    section: 'pricing',
    q: 'كيف أرقّي خطتي؟',
  ...
  // ── تقني (tech) ───────────────────────────────────────────────────────
  {
    ...
    a: 'هتلاقي زرار عائم بنفسجي ✨ في الزاوية في كل صفحة. اضغطي عليه واسألي أي سؤال بالعربي عن استخدام التطبيق. المساعد يجاوب فوراً + يديك زر "افتح الصفحة" ينقلك للمكان المطلوب. مدعوم بـ Claude AI.',
  },
  {
    section: 'tech',

      ...
      <div className="mb-6">
        <nav className="flex space-x-8" aria-label="Tabs">
          ...
          {user?.role === 'admin' && (
            ...
            >
              روابط التسجيل ({registrationLinks.length})
            </button>
          )}
          {user?.role === 'admin' && (
            <button
            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm font-medium text-gray-500">معرف المجمع</p>
            ...
            <div className="space-y-4">
              ...
              {compound?.additional_admins?.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">لا يوجد مديرين إضافيين</p>
                  <p className="text-sm text-gray-400">مساعدة الإدارة</p>
                </div>
              )}
            </div>
          </div>

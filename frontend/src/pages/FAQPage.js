...
const FAQS = [
  // ── عام (general) ─────────────────────────────────────────────────────
  {
    section: 'general',
    q: 'ما هو HomeMe؟',
    a: 'HomeMe هي منصة عربية لإدارة المجمعات السكنية والكمبوندات بالكامل من مكان واحد. تشمل: إدارة المدفوعات، تتبع الصيانة، الشكاوى، الأمن، الإعلانات، تقارير AI ذكية، وأكثر من 30 نظام متكامل لتشغيل مجمعك بكفاءة.',
  },
  {
    section: 'general',

    ...
    <div className="p-6">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">
                Total amount due: ${totalPending.toFixed(2)}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h4 className="font-medium text-blue-800 mb-2">Mock Payment System</h4>
            <p className="text-sm text-blue-700">
              This is a demonstration payment system. All payments are simulated and no real money is processed.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-blue-800 mb-2">Payment History</h4>
            <p className="text-sm text-blue-700">
              All your payment records are stored securely and can be accessed anytime from this dashboard.
            </p>
          </div>
        </div>
      </div>

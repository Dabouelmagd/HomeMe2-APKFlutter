  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className={`mb-6 p-4 rounded-lg ${biometricAvailable ? 'bg-green-50 border border-green-200' : 'bg-yellow-50 border border-yellow-200'}`}>
          <div className="flex items-center gap-3">
            {biometricAvailable ? (
              <>
                ...
                <div>
                  <p className="font-medium text-green-800">{t('biometric_supported', 'البصمة مدعومة')}</p>
                  <p className="text-sm text-green-600">{t('device_supports_biometric', 'جهازك يدعم تسجيل الدخول بالبصمة')}</p>
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  <p className="font-medium text-yellow-800">{t('biometric_not_supported', 'البصمة غير مدعومة')}</p>
                  <p className="text-sm text-yellow-600">{t('device_not_support_biometric', 'جهازك لا يدعم تسجيل الدخول بالبصمة')}</p>
                </div>
              </>
            )}
          </div>
          ...
          <>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${hasBiometric ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'}`}>
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h4 className="font-medium text-blue-800 mb-2">{t('how_biometric_works', 'كيف تعمل البصمة؟')}</h4>

  ...
  const ownerNavigationSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'الميزانية العامة', href: 'owner-budget', icon: CurrencyDollarIcon, show: true },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'صحة الوسائط', href: 'media-health', icon: ShieldCheckIcon, show: true },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'سجل التحديثات', href: 'changelog', icon: DocumentTextIcon, show: activeRole === 'app_owner' },
  ...
  return (
    <div className={`flex h-screen bg-gray-50 dark:bg-gray-900 ${isRTL ? 'rtl' : 'ltr'}`} style={{overflow: "hidden", maxWidth: "100vw"}}>
      ...
      <div className="flex-1 flex flex-col h-screen lg:ml-0 min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden page-scroll min-w-0 max-w-full">

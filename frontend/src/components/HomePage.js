        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform animate-slideUp">
            ...
            <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">
              {t('demo_feature', 'Demo Feature')}
            </h3>
            <p className="text-gray-600 text-center mb-8">
              {t('trial_feature_message', 'This is a demo feature. Sign up to access full family management!')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={() => window.location.href = '/register'}
                className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg"
              >
                {t('sign_up_now', 'Sign Up Now')}
              </button>
              <button
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
                ...
                <ul className="space-y-3 mb-8 flex-grow">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600 text-sm">{t('service_family_management', 'إدارة العائلات')} ({t('limited', 'محدودة')})</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-gray-600 text-sm">{t('service_booking', 'حجز الخدمات')} ({t('bookings_2', '2 حجز')}/{t('person', 'شخص')})</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
                  ...
                  {isYearly && (
                    <>
                      ...
                      <p className="text-lg font-semibold text-gray-700">
                        {formatPrice(getYearlyTotal(12))} {t('per_year', '/year')}
                      </p>
                    </>
                  )}
                </div>
                ...
                <button
                  onClick={() => handleChoosePlan('basic_plan', getDiscountedPrice(12), 'basic')}
              ...
              <div className="relative bg-white rounded-xl shadow-lg p-8 flex flex-col border-2 border-purple-400">
                ...
                <div className="text-center mb-6">
                  ...
                  {isYearly && (
                    <>
                      <p className="text-sm text-green-600 mb-1">{t('save_10', 'وفر 10%')}</p>
                      <p className="text-lg font-semibold text-gray-700">
                        {formatPrice(getYearlyTotal(40))} {t('per_year', '/year')}
                      </p>
                    </>
                  )}
                </div>
                ...
                <button
                  onClick={() => handleChoosePlan('professional_plan', getDiscountedPrice(40), 'professional')}
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col">
                <div className="text-center mb-6">
                  ...
                  {isYearly && (
                    <>
                      <p className="text-sm text-green-600 mb-1">{t('save_10', 'وفر 10%')}</p>
                      <p className="text-lg font-semibold text-gray-700">
                        {formatPrice(getYearlyTotal(70))} {t('per_year', '/year')}
                      </p>
                    </>
                  )}
                </div>
                <ul className="space-y-3 mb-8 flex-grow">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600 text-sm">{t('unlimited_storage', 'مساحة تخزين غير محدودة')} + {t('all_services', 'جميع الخدمات')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-orange-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>

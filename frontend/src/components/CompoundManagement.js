      ...
      <div className="mb-6">
        <nav className="flex space-x-8" aria-label="Tabs">
          ...
          {user?.role === 'admin' && (
            ...
            >
              <svg className="h-4 w-4 text-current" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{minWidth: '16px', minHeight: '16px'}}>
          ...
          {user?.role === 'admin' && (
            ...
            >
              <ShieldCheckIcon className="h-4 w-4 text-current" style={{minWidth: '16px', minHeight: '16px'}} />

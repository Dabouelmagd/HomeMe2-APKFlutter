        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-xl font-semibold text-center text-center">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-xl font-semibold text-center text-center text-green-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              <h1 className="text-xl font-semibold text-center text-center text-gray-900 text-center">

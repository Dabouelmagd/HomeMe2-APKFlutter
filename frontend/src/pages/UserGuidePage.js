...
const CHAPTERS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: '📍 نظام التتبع', steps: [
        { s: 'الأمن → 📍 تتبع الأشخاص → الخريطة المباشرة' },
        { s: 'النقاط الخضراء = متصل الآن | الرمادية = غير متصل' },
        { s: 'اضغط على أي نقطة لرؤية الاسم والوقت والبطارية', tip: 'التحديث كل ثوانٍ' },
      ]},
    ],
  },
  {
    ...
    sections: [
      ...
      { title: '📝 المدونة اليومية بالـ AI', steps: [
        { s: 'كل يوم الساعة 9 صباحاً — مقالة عربية جديدة تلقائياً', tip: 'Claude Haiku يكتبها' },
        { s: '30 موضوع متنوع عن إدارة الكمبوندات لا يتكرر' },
        { s: 'إشعار Push لكل الأجهزة المسجلة فور النشر' },
        { s: 'للأونر: SuperAdmin → إدارة المدوّنة → تعديل/حذف المقالات' },
      ]},
    ],
  },
  {
  ...
  {
    id: 'tracking', icon: MapPinIcon, color: 'from-cyan-500 to-blue-600', badge: 'جديد',
    title: 'نظام التتبع الداخلي', desc: 'تتبع أفراد العائلة والسواقين والمساعدين داخل الكمبوند',
    sections: [
      { title: '📍 كيف يعمل نظام التتبع', steps: [
        { s: 'الأمن → 📍 تتبع الأشخاص' },
        { s: 'اضغط "+ إضافة" واختر نوع الشخص (عائلة/سائق/مساعد/أمن/سيارة)' },
        { s: 'أدخل الاسم، الهاتف، واللون' },
        { s: 'يظهر كود QR — أعطه للشخص ليبدأ مشاركة موقعه', tip: 'التتبع اختياري 100% — يحتاج موافقة الشخص' },
        { s: 'تشوف موقعه على الخريطة مباشرةً بشكل فوري' },
      ]},
      { title: '6 أنواع للتتبع', steps: [
        { s: '👨‍👩‍👧 فرد عائلة — زوجة، أولاد' },
        { s: '🚗 سائق — سواق خاص أو أوبر' },
        { s: '👷 مساعد منزلي — خادمة، سفرجي' },
        { s: '🛡️ أمن — حارس أو مرافق خاص' },
        { s: '🚙 سيارة — تتبع المركبة' },
        { s: '📍 أخرى — أي شخص آخر' },
      ]},
      { title: '🔒 الخصوصية والأمان', steps: [
        { s: 'التتبع اختياري — لا يمكن تفعيله بدون موافقة الشخص', warn: true },
        { s: 'الشخص يتحكم في إيقاف المشاركة من هاتفه في أي وقت' },
        { s: 'سجل المواقع يُحذف تلقائياً بعد 24 ساعة' },
        { s: 'البيانات لا تخرج خارج الكمبوند أبداً', tip: 'كل البيانات مشفرة ومحمية' },
      ]},
    ],
  },
  {
    id: 'updates', icon: BellAlertIcon, color: 'from-violet-500 to-purple-600', badge: 'جديد',
    title: 'تحديثات التطبيق', desc: 'نشر التحديثات وإشعار المستخدمين فوراً',
    sections: [
      { title: '📢 للأونر — نشر تحديث', steps: [
        { s: 'SuperAdmin → تبويب "🆕 تحديثات التطبيق"' },
        { s: 'اختر نوع التحديث: ✨ ميزة / 🔧 إصلاح / 🔒 أمان / ⚡ تحسين' },
        { s: 'أدخل العنوان، رقم الإصدار (مثل: v2.4)، والتفاصيل' },
        { s: 'اضغط "📢 نشر وإرسال إشعار للجميع"', tip: 'يُرسل إشعار فوري لكل المستخدمين تلقائياً' },
      ]},
      { title: '🔔 للمستخدمين — رؤية التحديثات', steps: [
        { s: 'أيقونة ⬆️ في البار العلوي مع badge أخضر' },
        { s: 'الضغط عليها يفتح قائمة كل التحديثات' },
        { s: 'يظهر النوع، الوصف، ووقت التحديث' },
        { s: 'البادج يختفي فور فتح القائمة', tip: 'يتحدث تلقائياً كل 5 دقائق' },
      ]},
    ],
  },
  {
    id: 'ads', icon: MegaphoneIcon, color: 'from-orange-500 to-amber-600', badge: 'إيرادات',
    title: 'المساحات الإعلانية', desc: 'نظام الإعلانات داخل الكمبوندات وإدارة الإيرادات',
    sections: [
      { title: '4 مساحات إعلانية في كل كمبوند', steps: [
        { s: 'أعلى لوحة التحكم (728×90) — 1,500 ج.م/شهر', tip: 'الأعلى مشاهدةً' },
        { s: 'الشريط الجانبي (300×250) — 900 ج.م/شهر' },
        { s: 'داخل المحتوى (468×60) — 600 ج.م/شهر' },
        { s: 'أسفل الصفحة (728×90) — 750 ج.م/شهر' },
      ]},
      { title: '📋 كيف يحجز المعلن', steps: [
        { s: 'يضغط على المساحة الفارغة داخل الكمبوند' },
        { s: 'يفتح نموذج: الاسم، الإيميل، الهاتف، المدة (1/3/6/12 شهر)' },
        { s: 'يُحسب السعر تلقائياً → إرسال الطلب', tip: 'خصم تلقائي للمدد الطويلة' },
        { s: '📧 يصل إيميل فوراً للأونر ومساعديه مع كل تفاصيل الطلب' },
      ]},
      { title: '✅ للأونر — الموافقة والإدارة', steps: [
        { s: 'SuperAdmin → الإعلانات → طلبات المساحات' },
        { s: 'راجع الطلب: المعلن، المساحة، المبلغ، المدة' },
        { s: '"✅ موافقة" → يُفعّل الإعلان ويُرسل إيميل للمعلن' },
        { s: '"❌ رفض" + سبب → يُرسل إيميل للمعلن تلقائياً' },
        { s: 'الإيرادات تظهر في التقارير المالية الموحدة' },
      ]},
    ],
  },
  {
    id: 'translation', icon: GlobeAltIcon, color: 'from-sky-500 to-blue-600', badge: 'إدارة',
    title: 'نظام الترجمة', desc: 'إدارة ترجمات التطبيق بالثلاث لغات بدون rebuild',
    sections: [
      { title: '3 لغات مدعومة', steps: [
        { s: '🇸🇦 العربية — اللغة الافتراضية' },
        { s: '🇬🇧 الإنجليزية — للمستخدمين الدوليين' },
        { s: '🇫🇷 الفرنسية — للمستخدمين الفرانكفون' },
        { s: 'يتذكر التطبيق لغة المستخدم تلقائياً', tip: 'كل مستخدم يختار لغته من الإعدادات' },
      ]},
      { title: '⚡ تعديل الترجمات من الداشبورد', steps: [
        { s: 'SuperAdmin → إدارة الترجمات', tip: 'للأونر فقط' },
        { s: 'ابحث عن أي كلمة أو مفتاح' },
        { s: 'عدّل القيمة في AR / EN / FR' },
        { s: 'اضغط حفظ → يطبَّق فوراً بدون إعادة بناء', tip: 'Cache 30 دقيقة ثم يتجدد تلقائياً' },
        { s: '"✨ Auto-Translate" لترجمة تلقائية بالـ AI' },
        { s: 'تصدير/استيراد ملفات JSON للترجمة الجماعية' },
      ]},
    ],
  },
  {
    id: 'gov', icon: BuildingOffice2Icon, color: 'from-blue-700 to-indigo-800', badge: 'جديد',
    title: 'دليل المحافظات والمحليات', desc: 'إدارة الأحياء والمراكز والمحافظات من لوحة تحكم واحدة',
    sections: [
      { title: '🏛️ الوحدات الإدارية المدعومة', steps: [
        { s: '🏘️ حي / منطقة — إدارة الأحياء السكنية حتى 50 كمبوند' },
        { s: '🏛️ مركز / قضاء — إدارة عدد غير محدود من الأحياء' },
        { s: '🏙️ محافظة / مدينة — إدارة كاملة مع GIS متقدم' },
        { s: 'كل وحدة لها: مدير + موظفون + ميزانية + تقارير مستقلة', tip: 'يمكن ربط الكمبوندات الخاصة بكل وحدة' },
      ]},
      { title: '📊 لوحة التحكم', steps: [
        { s: 'من الـ Owner Dashboard → قسم المحافظات والمحليات' },
        { s: '6 مؤشرات: الوحدات / الكمبوندات / السكان / الإيرادات / الاشتراكات / الشكاوى' },
        { s: 'زر "فتح اللوحة الكاملة" → /app/gov-dashboard' },
        { s: 'مخطط إيرادات كل وحدة إدارية بشكل مقارن', tip: 'يتحدث تلقائياً مع كل refresh' },
      ]},
      { title: '👥 إضافة موظفين لكل وحدة', steps: [
        { s: 'اختر الوحدة الإدارية من تبويب الوحدات أو الموظفون' },
        { s: 'اضغط "+ موظف جديد" واختر الدور: مدير / محاسب / إداري / أمن / موظف' },
        { s: 'أدخل الاسم + الإيميل', tip: '📧 يُرسل إيميل تلقائياً بكلمة مرور مؤقتة' },
        { s: 'الموظف يدخل بـ username + كلمة المرور المؤقتة ويغيّرها فور الدخول', warn: true },
      ]},
      { title: '📧 إرسال دعوات الانضمام', steps: [
        { s: 'من داخل الوحدة الإدارية → زر "📧 دعوة"' },
        { s: 'اختر طريقة الدعوة: إيميل / كود فقط / إيميل + كود' },
        { s: 'أدخل الإيميل والدور (مقيم / مدير / موظف)' },
        { s: 'يُنشأ كود مميز (GOV-XXXXXX) + رابط تسجيل مباشر', tip: 'الكود يُنسخ تلقائياً للـ clipboard' },
        { s: 'صالح 30 يوماً — يمكن إلغاؤه في أي وقت' },
      ]},
      { title: '💰 الإيرادات والمصروفات', steps: [
        { s: 'تبويب "الإيرادات" → ملخص شهري / ربع سنوي / سنوي' },
        { s: 'إجمالي الإيرادات + المصروفات + الصافي + التحصيل المعلق' },
        { s: 'MRR (الإيرادات الشهرية المتكررة) + تقدير ARR سنوي' },
        { s: 'مخطط إيرادات كل وحدة إدارية مقارناً بالأخرى', tip: 'يشمل مدفوعات كل الكمبوندات المرتبطة' },
      ]},
      { title: '📋 الاشتراكات', steps: [
        { s: 'تبويب "الاشتراكات" → كل اشتراكات الوحدات الإدارية' },
        { s: 'نشطة / تجريبية / منتهية مع MRR الكلي' },
        { s: 'تفاصيل كل اشتراك: الخطة + المبلغ + الحالة' },
      ]},
    ],
  },
  {
    ...
    sections: [
      ...
      { title: '✨ مميزات حصرية جديدة في كل الخطط', steps: [
        { s: '📍 نظام التتبع الداخلي — عائلة، سائق، مساعد' },
        { s: '🔔 تحديثات التطبيق — إشعار فوري لكل المستخدمين' },
        { s: '📢 المساحات الإعلانية — 4 مساحات داخل الكمبوند' },
        { s: '📝 مدونة AI يومية — مقالة عربية كل يوم 9 صباحاً' },
        { s: '🌐 ترجمة حية — تعديل فوري بدون إعادة بناء' },
        { s: '💾 نسخ احتياطي + فحص صحة المسارات يومياً' },
      ]},
    ],
  },
  {
